...
namespace Lerevently.Modules.Attendance.Infrastructure.Inbox;
    ...
    where TIntegrationEvent : IIntegrationEvent
{
        ...
        InboxMessageConsumer inboxMessageConsumer)
    {
        const string sql =
            ...
            SELECT EXISTS(
                SELECT 1
                FROM attendance."InboxMessageConsumer";
        ...
        InboxMessageConsumer inboxMessageConsumer)
    {
        const string sql =
            """
            INSERT INTO attendance."InboxMessageConsumer"("InboxMessageId", "Name")
